...
Original file is located at
    https://colab.research.google.com/drive/17ZGWNOvEYoknARp_LWVdF_Xfy5ziPDLz
"""
...
def residual_block(in_x, in_filters, out_filters, stride, tst, name):
    ...
    conv_1 = batch_norm(in_x)
    conv_11 = _conv(conv_1,[3, 3, in_filters, out_filters], stride)
    relu_1 = tf.nn.relu(conv_11) 
    
    conv_2 = batch_norm(relu_1)
    conv_22 = _conv(conv_2,[3, 3, in_filters, out_filters], stride)
    relu_2 = tf.nn.relu(conv_22) 
    ...
    if in_filters != out_filters:
        ...
        identity = tf.pad(pooled_input, [[0, 0], [0, 0], [0, 0], [left_pad, right_pad]])  
        
        return identity + relu_2
    else:
        return in_x + relu_2
